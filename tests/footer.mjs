...
export const NAV_GROUPS = [
  ...
  { label: "chapters", items: ["/africa/", "/latam/", "/asia/", "/europe/", "/north-america/", "/mena/", "/oceania/"] },
...
export const NAV_META = {
  ...
  "/latam/": ["Latin America chapter", "seat open — radar + stewardship"],
  "/asia/": ["Asia chapter", "seat open — radar + stewardship"],
  "/europe/": ["Europe chapter", "seat open — radar + stewardship"],
  "/north-america/": ["North America chapter", "seat open — radar + stewardship"],
  "/mena/": ["MENA chapter", "seat open — radar + stewardship"],
  "/oceania/": ["Oceania chapter", "seat open — radar + stewardship"],
