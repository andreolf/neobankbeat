  ...
  <div class="jmatch" id="jmatch">
    <div class="jmpanel" id="jmpanel">
      ...
      <div class="jmupload" id="jmdrop" tabindex="0" role="group" aria-label="Upload CV file">
        ...
        <div class="sub" id="jmupsub">Drop anywhere in this box · PDF or Word with selectable text</div>
...
function setFileUI(name){
  if(name){
    ...
    upTitle.textContent='Drop your CV here';upSub.textContent='Drop anywhere in this box · PDF or Word with selectable text';icoEl.textContent='↑';
  }
}
