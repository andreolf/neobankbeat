...
description: "Independent, open-source directory of 362 verified-active neobanks — compared on custody, regulation, cards, cashback, yield, stablecoins, KYC and geography."
...
- [Full dataset (JSON)](https://www.neobankbeat.com/data.json): all 362 entities with category, custody, regulation type, card network, cashback, yield, stablecoin support, KYC, audience niche, HQ, founding year, active regions/countries, verified terms & privacy URLs, X handles, founders, funding, notable early investors (name + website), and reported user/volume figures with sources. This is the preferred way for agents to consume the data — no HTML or JS parsing needed.
...
- [Directory](https://www.neobankbeat.com/#directory): searchable, filterable grid of all 362 entities with side-by-side compare
...
- [Investors in neobanks](https://www.neobankbeat.com/investors/): 198 venture and strategic investors mapped to the neobanks they backed, from publicly disclosed rounds — each firm has its own page at /investors/<slug>/ with fund history, key people, portfolio and co-investors
- [Newsletters](https://www.neobankbeat.com/newsletters/): the 10 neobank & fintech newsletters worth reading, hand-picked with authors and focus
...
- [All 362 entity profiles](https://www.neobankbeat.com/n/): one page per neobank at /n/<slug>/ with custody, licence, cards, stablecoins, verified links and peers
