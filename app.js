...
["Purple","T","US","New York, US",2018,"C","MC","Debit","—","—",0,"Y","ds","getpurple.io","Banking for people with disabilities; ABLE-friendly."],
...
/* ══ TRADITIONAL · UK ══ */
["Monzo","T","UK","London, UK",2015,"C","MC","Debit","—","~4% savings pots",0,"Y","g","monzo.com","12M+ customers; UK licence; US expansion."],
...
["Trade Republic","T","Europe","Berlin, DE",2015,"C","Visa","Debit","1% saveback","~ECB rate on cash",0,"Y","g","traderepublic.com","Broker with full bank licence; custodial crypto."],
...
["Plata","T","LatAm","Mexico City, MX",2023,"C","MC","Credit + debit","Cashback","Interest on deposits",0,"Y","g","platacard.mx","Ex-Tinkoff team; fastest digital bank ever to $600M annualized revenue — full Mexican licence as Banco Plata (Mar 2026), 3.5M+ credit-card customers."],
...
["Tonik","T","Asia","Manila, PH",2018,"C","MC","Debit","—","Up to 6% time deposits",0,"Y","g","tonikbank.com","First PH neobank licence."],
...
["Umba","T","Africa","Lagos/Nairobi",2018,"C","—","Digital banking","—","—",0,"Y","g","umba.com","NG + KE digital bank (acquired MFB licence)."],
...
["Zand","T","MENA","Dubai, AE",2022,"C","Visa","Digital banking","—","Deposits",0,"Y","g","zand.ae","First UAE all-digital bank licence; crypto-friendly corporate banking."],
...
["Krak","H","Global","San Francisco, US",2025,"C","MC","Debit","Spend rewards","Yield incl. stables",1,"Y","g","krak.com","Kraken's consumer money app."],
...
["XPlace","H","Global","Dubai, AE",2023,"C","Visa/MC","Prepaid","—","—",1,"Y","g","xplace.app","Crypto card (Pontech issuance)."],
...
["Solflare","W","Global","Belgrade, RS",2017,"S","Visa","Wallet + card","Card rewards","SOL staking",1,"CO","g","solflare.com","Solana-native wallet with card."],
...
["Zengo","W","Global","Tel Aviv, IL",2018,"M","—","Wallet (no card)","—","—",1,"N","g","zengo.com","MPC wallet, no seed phrase."],
...
["Ready","W","Global","London, UK",2018,"S","Visa","Metal + virtual","3% in STRK","Staking + BTCFi",1,"CO","g","ready.co","Formerly Argent; smart-account onchain bank."],
...
["Sling Money","W","Global","London, UK",2023,"S","—","P2P money app","—","—",1,"Y","g","sling.money","Wise-alumni stablecoin P2P on Solana."],
...
const LOGOMAP={"Moniepoint":"/logos/moniepoint.png"};
...
/* ═══ ENRICHMENT LAYER · profiles, licences, founders, funding, world map ═══
   X[name] = { f: founders, l: licence, m: money raised, s: story, a: active macro regions override } */
const X={
/* US */
...
"C24 Bank":{l:"Full German banking licence (BaFin); CHECK24 subsidiary"},
"Indy":{l:"Accounts via Swan, ACPR-licensed e-money institution (France); French IBAN"},
"Fortuneo":{l:"Crédit Mutuel Arkéa banking licence (ACPR, France); brand of the group's online bank"},
"Tinaba":{l:"Partner bank (Banca Profilo, Bank of Italy register no. 5271); Tinaba is the tech layer"},
"Openbank":{l:"Full banking licence within Santander Group (ECB/Bank of Spain); US via Santander Bank N.A."},
"Paysera":{l:"E-money institution licence (Bank of Lithuania, 2012); EEA passported"},
"Cuenca":{l:"IFPE licence (CNBV, Mexico, 2021) under Ley Fintech"},
"Movii":{l:"SEDPE e-money licence (Superintendencia Financiera, Colombia)"},
"TNEX":{l:"Operates under Maritime Bank's (Vietnam) banking licence as its digital bank"},
"Liv.":{l:"Operates under Emirates NBD's banking licence (CBUAE) as its digital bank"},
"CEX.IO Card":{l:"MSB (FinCEN) + US state money-transmitter licences; UK FCA cryptoasset registration; EU VASP (Lithuania)"},
"Trustee Plus":{l:"Lithuanian VASP (UAB Trustee Global); pursuing MiCA CASP licence after Jan 2026 wind-down"},
"Meru":{l:"MSB registration (FinCEN, R3mit Solutions Inc.); USDC accounts via licensed US/EU partners"},
"Zak":{l:"Operates under Bank Cler's Swiss banking licence (FINMA)"},
"Paytm":{l:"UPI TPAP riding on partner banks (Axis, Yes Bank, SBI, HDFC); wallet wound down with bank unit"},
"DANA":{l:"E-money issuer licence (Bank Indonesia)"},
"Touch 'n Go eWallet":{l:"E-money issuer licence (Bank Negara Malaysia)"},
"Allica Bank":{l:"Full UK banking licence (PRA/FCA authorised)"},
"Northmill":{l:"Swedish banking licence (Finansinspektionen, since 2019)"},
"Flowe":{l:"E-money institution (IMEL, Bank of Italy, 2019); founded by Banca Mediolanum"},
"imagin":{l:"Operates under CaixaBank's Spanish banking licence (ECB/Bank of Spain supervised)"},
"RappiPay":{l:"Finance company charter (compania de financiamiento, SFC Colombia, 2022); Rappi-Davivienda JV; Fogafin-insured"},
"NG.cash":{l:"Payment institution (Banco Central do Brasil, e-money issuer licence, May 2025)"},
"RazorpayX":{l:"Partner banks (RBL, ICICI, Yes, Axis, IDFC First); Razorpay holds RBI payment aggregator licence"},
...
"UR":{l:"Swiss fintech banking licence (Art. 1b Banking Act, FINMA; SR Saphirstein AG); tokenized deposits"},
...
"GrabPay":{l:"Major payment institution (MPI) licence (MAS Singapore, PS20200167); e-money issuer"},
...
"Fyrst":{l:"Brand of Deutsche Bank AG — full German banking licence (ECB/BaFin); Postbank rails"},
"Rocker":{l:"Operates under Bankaktiebolaget Nordiska's Swedish banking licence (Finansinspektionen); own PI licence returned Sep 2025"},
"buddybank":{l:"UniCredit S.p.A. digital service — operates under UniCredit's Italian banking licence (ECB supervised)"},
"MyInvestor":{l:"Own Spanish banking licence (MyInvestor Banco S.A., Banco de España no. 1544; Andbank group); CNMV supervised"},
"Snappi":{l:"Full ECB banking licence (via Bank of Greece, Jun 2024); Piraeus-backed digital bank"},
"Fondeadora":{l:"SOFIPO licence (Fondea Technologies S.F.P., CNBV Mexico, ex-Apoyo Múltiple); Prosofipo deposit insurance"},
...
"XPlace":{l:"Self-custodial (non-custodial Solana smart contracts); cards issued via Rain (Signify Holdings) under Visa licence"},
...
"Zempler Bank":{l:"Full UK banking licence (PRA/FCA, Feb 2021, ex-Cashplus); FSCS-protected"},
"Hello bank!":{l:"Operates under BNP Paribas' French banking licence (direct-bank brand)"},
"Hype":{l:"E-money institution (IMEL, Banca d'Italia); being merged into Banca Sella (2026)"},
"isybank":{l:"Own Italian banking licence (Intesa Sanpaolo group; ECB/Banca d'Italia supervised)"},
"ZEN.com":{l:"E-money institution (Bank of Lithuania, LB000457, 2018)"},
"Hey Banco":{l:"Own Mexican banking licence (CNBV banca múltiple); independent of Banregio since Jan 2026"},
"Daviplata":{l:"Operates under Banco Davivienda's Colombian banking licence (SFC-supervised)"},
"Qik":{l:"Full banking licence (banco múltiple, Dominican Republic, Oct 2022; Grupo Popular)"},
"Nagad":{l:"Mobile money licence (Bangladesh Bank MFS, with Bangladesh Post Office); 2024 digital-bank licence under review"},
"KuCard":{l:"Card issued by Wallester AS (Estonian payment institution); KuCoin EU holds Austrian MiCA CASP licence"},
"Tap Global":{l:"Gibraltar DLT/VASP licence (GFSC, No. 25532); cards via Transact Payments EMI"},
"Kolo":{l:"AIFC FinTech Lab licence (Kazakhstan) + Polish VASP; cards issued by Banco Popular de Puerto Rico"},
"Bling":{l:"E-money distributor of Treezor (ACPR-licensed French EMI, Société Générale group)"},
"Munify":{l:"US accounts via partner banks; in-principle DFSA licence approval (UAE, Nov 2025)"},
"PhonePe":{l:"RBI PPI wallet (e-money issuer) + payment aggregator licence (2025); IRDAI insurance broking"},
"OVO":{l:"Bank Indonesia e-money licence (PT Visionet Internasional, 2017); QRIS + funds-transfer licences"},
"ZaloPay":{l:"Licensed payment institution (SBV intermediary payment services licence 04/GP-NHNN); Zion/VNG e-wallet"},
...
"Vision Bank":{l:"Full Saudi digital bank licence (SAMA); full operations approved Sep 2025"},
...
"Fasset":{l:"VARA VASP licence (Dubai, broker-dealer); provisional Islamic digital-bank licence in Malaysia"},
"Moneco":{l:"Accounts and cards via regulated EMI partners (Europe/US); Moneco Canada registered with FINTRAC"},
"OakNorth":{l:"Full UK banking licence (PRA/FCA, 2015)",ai:"underwriting"},
"TrueMoney":{l:"E-money licence (Bank of Thailand) via Ascend Money; local e-money/payments licences across 7 SEA markets",ai:"underwriting"},
"GCash":{l:"E-money issuer licence (EMI-NBFI, Bangko Sentral ng Pilipinas) via G-Xchange Inc.; Mynt group",ai:"underwriting"},
"Nequi":{l:"Licensed compañía de financiamiento (Superfinanciera Colombia); spun out of Bancolombia's banking licence",ai:"underwriting"},
"MoMo":{l:"Intermediary payment services / e-wallet licence from State Bank of Vietnam; mobile money super-app",ai:"underwriting"},
...
"Robinhood":{ai:"interface",f:"Vlad Tenev, Baiju Bhatt",l:"Broker-dealer + partner banks; state crypto licences",m:"Public (HOOD)"},
/* Canada */
"KOHO":{f:"Daniel Eberhard",m:"~C$400M raised",l:"Pursuing Schedule 1 bank licence"},
...
/* UK */
"Monzo":{f:"Tom Blomfield + 4 co-founders",l:"UK banking licence",m:"~£1.1B raised",s:"The hot-coral card that made banking a brand; born from the Mondo prepaid beta and a record 96-second crowdfund."},
"Starling Bank":{ai:"interface",f:"Anne Boden",l:"UK banking licence",m:"~£900M raised",s:"Anne Boden left a 30-year banking career at 54 to build the UK's first consistently profitable neobank."},
"Atom Bank":{f:"Anthony Thomson, Mark Mullen",l:"UK banking licence"},
"Zopa Bank":{ai:"underwriting",f:"Giles Andrews, James Alexander",l:"UK banking licence (2020)",m:"~$1B raised",s:"Invented P2P lending in 2005, then traded the model for a full bank licence."},
"Chase UK":{l:"UK subsidiary of JPMorgan"},
"Kroo":{f:"Nazim Valimahomed",l:"UK banking licence"},
...
"Pockit":{l:"E-money via FCA-authorised EMIs (Modulr, PSI-Pay); owns Monese's EMI licence",f:"Virraj Jatania",s:"Accounts for the UK's financially excluded; absorbed Monese's consumer base."},
"Tandem Bank":{l:"UK banking licence",s:"Pivoted from challenger #2 to a green lender financing home decarbonisation."},
...
/* Europe */
"N26":{f:"Valentin Stalf, Maximilian Tayenthal",l:"German banking licence",m:"~$1.8B raised",s:"Berlin's minimalist bank that scaled across the EU, retreated from UK/US, and finally reached profitability."},
"bunq":{ai:"interface",f:"Ali Niknam",l:"Dutch banking licence",m:"Founder-funded (~€100M of Niknam's own) + raises",s:"Ali Niknam bootstrapped the Netherlands' first new banking licence in 35 years with his own money."},
...
"Tomorrow":{l:"Partner bank (Solaris SE, full German banking licence, BaFin-supervised)",f:"Inas Nureldin, Jakob Berndt, Michael Schweikart",s:"Hamburg social business: card spend funds climate projects."},
...
"Qonto":{ai:"interface",f:"Alexandre Prot, Steve Anavi",l:"Payment institution (ACPR); pursuing credit licence",m:"~€620M raised",s:"Europe's SME banking leader out of Paris; absorbed Penta to own the German market too."},
...
"Sumeria (Lydia)":{l:"E-money institution (Lydia Solutions, ACPR France, CIB 17598); credit-institution licence applied for",f:"Cyril Chiche, Antoine Porte",m:"~€260M raised",s:"France's 'send me a Lydia' P2P verb rebranded to Sumeria to become a real current account."},
...
"Lunar":{ai:"interface",f:"Ken Villum Klausen",l:"Danish banking licence",m:"~$500M raised"},
"indó":{f:"Haukur Skúlason, Tryggvi Björn Davíðsson",l:"Icelandic banking licence"},
"Trade Republic":{f:"Christian Hecker, Thomas Pischke, Marco Cancellieri",l:"German full banking licence (2023)",m:"~€1.2B raised",s:"Berlin broker that pays ECB rate on cash and hands out 1% saveback — a bank disguised as a savings plan."},
...
"Wise":{f:"Kristo Käärmann, Taavet Hinrikus",l:"E-money/payment licences globally",m:"Public (WISE.L)",s:"Two Estonians tired of hidden FX fees built mid-market-rate transfers; now moving £100B+ a year.",a:["EU","NA","ASIA","OC","LATAM","AF","MENA"]},
"Klarna":{ai:"interface",f:"Sebastian Siemiatkowski, Niklas Adalberth, Victor Jacobsson",l:"Swedish banking licence",m:"Public (KLAR, 2025)"},
"Salt Bank":{l:"Bank (Banca Transilvania)"},
"Papara":{l:"E-money institution (CBRT, Turkey); licence revoked Oct 2025, reinstated under state trusteeship",f:"Ahmed Karslı",m:"Profitable; acquired SadaPay (2024)",s:"Istanbul's fintech champion: 17M users and an M&A run across Turkey and Pakistan."},
"Enpara":{l:"Bank (QNB Finansbank)"},
"Monobank":{f:"Oleh Gorokhovskyi, Mykhailo Rogalskyi",l:"Operates on Universal Bank licence",m:"Bootstrapped, profitable",s:"Built by the ex-PrivatBank team; kept Ukraine's payments running through blackouts and full-scale war, with a cat mascot."},
"T-Bank":{ai:"interface",f:"Oleg Tinkov (exited 2022)",l:"Russian banking licence",m:"Public (MOEX)",s:"Tinkov built the world's largest standalone digital bank from a credit-card mailer; sanctions forced his exit."},
"Kaspi":{f:"Mikheil Lomtadze, Vyacheslav Kim",l:"Kazakh banking licence",m:"Public (KSPI)",s:"Turned a distressed Kazakh bank into a super-app processing most of the country's payments and e-commerce."},
"Uzum":{l:"Bank licence (UZ)"},
"TBC UZ":{ai:"underwriting",l:"Bank (TBC Group)",m:"Public parent (TBCG.L)"},
"Alpian":{f:"Schuyler Weiss",l:"Swiss banking licence",m:"~CHF200M+ raised"},
"Yuh":{f:"Swissquote x PostFinance JV",l:"On Swissquote's banking licence"},
...
/* LatAm */
"Nubank":{ai:"underwriting",f:"David Vélez, Cristina Junqueira, Edward Wible",l:"Bank licences BR/MX/CO; conditional US OCC approval (2026)",m:"Public (NU)",s:"Started after David Vélez's kafkaesque São Paulo branch visit; now Latin America's most valuable financial institution with 100M+ customers."},
"Ualá":{ai:"underwriting",f:"Pierpaolo Barbieri",l:"Bank licences (AR via Wilobank, MX via ABC Capital)",m:"~$1B+ raised incl. $195M round (Mar 2026) at $3.2B",s:"Buenos Aires historian-turned-founder set out to bank every Argentine teenager; now ~1 in 5 Argentine adults use it, with 11M+ customers across AR/MX/CO."},
"Plata":{ai:"underwriting",f:"Neri Tollardo (CEO) + ex-Tinkoff team",l:"Full Mexican bank licence (Banco Plata, Mar 2026); Colombia Compañía de Financiamiento authorized",m:"$405M Series C at $5B (Apr 2026, Bicycle Capital, QIA, BTG Pactual) — $2B+ debt & equity total",s:"The Tinkoff playbook replayed in Mexico: proprietary core banking + AI risk engine built by 800 STEM hires, 750K first-time cardholders, $800M loan book — LatAm's most valuable private digital bank three years after founding."},
"albo":{l:"IFPE licence (CNBV, Mexico, 2022) — e-money institution under Ley Fintech",f:"Ángel Sahagún",m:"~$150M+ raised"},
"Klar":{l:"SOFIPO licence (CNBV, Mexico); acquiring Bineo for its bank licence, approvals pending",ai:"underwriting",f:"Stefan Möller, Daniel Autrique",m:"~$500M incl. debt"},
...
"C6 Bank":{ai:"interface",f:"Marcelo Kalim, Carlos Fonseca (ex-BTG)",l:"Bank licence (BCB)",m:"JPMorgan ~46% owner"},
...
"Cora":{l:"SCFI licence (Central Bank of Brazil, Jul 2024) + payment institution; formerly SCD",f:"Igor Senra, Leo Mendes",m:"~$200M raised"},
"Naranja X":{l:"Bank (Grupo Galicia)"},
"Brubank":{f:"Juan Bruchou",l:"Bank licence (BCRA)"},
"Lulo Bank":{l:"Bank licence (CO)"},
"Tenpo":{f:"Krealo (Credicorp)",l:"Preparing Chilean bank licence"},
"Global66":{l:"Prepaid-card e-money issuer licence (CMF, Chile); cross-border FX via Global 81 SpA",f:"Tomás Bercovich",m:"~$65M raised"},
"Mercado Pago":{ai:"underwriting",f:"Marcos Galperin (MELI)",l:"Payment/fintech licences region-wide; pursuing MX bank licence",m:"Public (MELI)",s:"MercadoLibre's payments arm became LatAm's default wallet; issues the Meli Dollar stable token in Brazil.",a:["LATAM"]},
...
"Félix":{l:"US money transmitter — state licences (NMLS 2302775); agent of UniTeller/Intermex; USDC rails via Bitso",ai:"interface",f:"Manuel Godoy",m:"~$45M raised",s:"Send dollars home over WhatsApp; stablecoin rails under a chat interface."},
...
"Bitso":{f:"Daniel Vogel, Pablo González, Ben Peters",l:"IFPE (MX) + regional VASP licences",m:"~$400M (val $2.2B)",s:"Mexico's first crypto unicorn; powers a meaningful share of US–MX remittances over stablecoin rails."},
...
"ueno bank":{l:"Bank licence (PY)"},
/* Africa */
"TymeBank":{f:"Coen Jonker + team",l:"SA banking licence",m:"~$400M; unicorn (2024)",s:"Kiosk onboarding inside Pick n Pay stores cracked mass-market South African banking; now exporting the model to Asia."},
"Bank Zero":{f:"Michael Jordaan, Yatin Narsai",l:"Mutual bank licence (SA)",s:"Ex-FNB CEO's zero-fee mutual bank built on its own core stack."},
"Discovery Bank":{ai:"interface",l:"SA banking licence"},
...
"OPay":{f:"Yahui Zhou (Opera)",l:"Payment licences (NG)",m:"~$570M raised",s:"Opera's super-app bet on Nigeria; 60M users via a massive street-agent network."},
"PalmPay":{ai:"underwriting",f:"Transsion-backed team",l:"Mobile money licence (NG)"},
"Moniepoint":{ai:"underwriting",f:"Tosin Eniolorunda, Felix Ike",l:"MFB + switching licences (NG)",m:"~$180M+; unicorn",s:"Started as agent-banking infrastructure, became the bank behind millions of Nigerian small businesses."},
...
"Umba":{l:"Microfinance bank licence in Kenya (majority stake in Daraja MFB, CBK-approved 2022); Nigeria via partner bank",f:"Tiernan Kennedy, Barry O'Mahony",m:"~$20M raised"},
"Djamo":{l:"Microfinance licence (BCEAO / Côte d'Ivoire MEF, Sep 2025 — first fintech); cards with partner banks",f:"Hassan Bourgi, Régis Bamba",m:"~$30M raised",s:"YC's first Ivorian startup; banking francophone West Africa's mobile-money generation."},
...
"Eversend":{l:"E-money issuer + PSP licences (Bank of Uganda); FinCEN and FINTRAC registrations",f:"Stone Atwine"},
"Fingo":{l:"Partner bank (Ecobank Kenya); Central Bank of Kenya-approved product",f:"Kiiru Muhoya + team",m:"~$4M raised"},
"Branch Intl":{l:"Microfinance bank licence in Kenya (84.9% of Century MFB, CBK-approved 2022); digital lending in NG/IN",ai:"underwriting",f:"Matt Flannery (Kiva co-founder), Daniel Jung",m:"~$260M raised"},
"Khazna":{l:"Pursuing Central Bank of Egypt digital-bank licence (target mid-2026); lends via FRA-regulated entities",f:"Omar Saleh",m:"~$60M+ raised"},
"MNT-Halan":{l:"Microfinance and consumer finance licences (FRA, Egypt); e-payments arm licensed by CBE",ai:"underwriting",f:"Mounir Nakhla, Ahmed Mohsen",m:"~$600M+ incl. debt; unicorn"},
...
"Chipper Cash":{l:"Licensed e-money/payments across Africa (CBN, BoG, BoU, BNR); 40+ US money-transmitter licences; FCA EMI (UK)",f:"Ham Serunjogi, Maijid Moujaled",m:"~$300M raised",s:"Ugandan-Ghanaian founders built pan-African P2P; survived the FTX-investor winter and refocused on cards + crypto.",a:["AF","NA","EU"]},
...
"Wio Bank":{f:"ADQ, e&, FAB consortium",l:"UAE banking licence"},
"Zand":{f:"Mohamed Alabbar-led group",l:"UAE banking licence",s:"First fully digital UAE bank licence; corporate arm banks the Gulf's crypto companies."},
"YAP":{l:"Partner bank (Ruya Community Islamic Bank, CBUAE-licensed; formerly RAKBANK)",f:"Marwan Hachem, Anas Zaidan"},
"Pyypl":{l:"FSRA (ADGM) money services licence No. 170031; non-bank payment institution; also CBB Bahrain, AFSA Kazakhstan",f:"Antti Arponen",m:"~$60M raised"},
"NOW Money":{l:"E-money institution / Stored Value Facility licence (Central Bank of UAE); funds safeguarded at UAE banks incl. CBI",f:"Katharine Budd, Ian Dillon",s:"Payroll accounts for Gulf migrant workers excluded from traditional banks."},
...
"Tweeq":{l:"SAMA e-money licence"},
"STC Bank":{l:"Digital bank licence (SAMA)"},
"D360 Bank":{l:"Digital bank licence (SAMA); PIF-backed"},
"One Zero":{ai:"interface",f:"Amnon Shashua (Mobileye founder)",l:"Israeli banking licence",m:"~$500M raised",s:"Israel's first new bank in 40+ years, built around an AI private banker."},
...
/* Asia */
"KakaoBank":{ai:"underwriting",f:"Kakao consortium",l:"Internet-only bank licence (KR)",m:"Public (KRX)",s:"Launched from Korea's dominant messenger; 300K accounts in 24 hours, profitable within two years."},
"Toss Bank":{ai:"underwriting",f:"Lee Seung-gun (Viva Republica)",l:"Internet-only bank licence (KR)",m:"Viva Republica ~$1.7B raised",s:"A dentist-turned-founder failed eight startups before Toss; the bank arm now anchors Korea's super-app."},
"K bank":{l:"Internet-only bank licence (KT-led)",s:"Korea's first internet bank; balance sheet supercharged by being Upbit's banking partner."},
"WeBank":{ai:"underwriting",f:"Tencent-led consortium",l:"Private bank licence (CN)",s:"The world's largest digital bank: 400M+ customers on Tencent rails."},
"MYbank":{ai:"underwriting",f:"Ant Group-led",l:"Private bank licence (CN)"},
"Jupiter":{l:"Partner bank (Federal Bank); RBI PPI licence via parent Amica Financial Technologies",f:"Jitendra Gupta",m:"~$160M raised"},
"Niyo":{l:"Partner banks (SBM Bank India, DCB Bank) — RBI-regulated issuers; no own licence",f:"Vinay Bagri, Virender Bisht",m:"~$180M raised"},
...
"Mahila Money":{l:"No own licence; lends on RBI-licensed NBFC partners' rails (Capital Trade Links, RupeeCircle)",f:"Sairee Chahal",s:"From the SHEROES women's community to credit and accounts for women entrepreneurs in Bharat."},
"Oraan":{l:"SECP-registered; NBFC (non-bank finance company) licence from SECP Pakistan for lending; digital ROSCAs",f:"Halima Iqbal, Farwah Tapal",s:"Digitized Pakistan's women-led savings committees (ROSCAs) into a regulated product."},
"SadaPay":{l:"E-money institution (EMI) licence from State Bank of Pakistan; owned by Papara",f:"Brandon Timinsky",m:"~$20M; acquired by Papara"},
"NayaPay":{l:"E-money institution (State Bank of Pakistan EMI licence, 2021)",f:"Danish Lakhani",m:"~$13M raised"},
"bKash":{ai:"underwriting",f:"Kamal Quadir",l:"MFS licence (Bangladesh Bank)",m:"Ant + SoftBank-backed",s:"'bKash me' is a verb in Bangladesh: 70M users, the reference case for mobile money outside Africa."},
...
"YouTrip":{l:"Major Payment Institution (MPI) licence from MAS, Singapore — e-money issuance; funds safeguarded at DBS/StanChart/UOB",f:"Caecilia Chu, Arthur Mak",m:"~$100M+ raised"},
"Tonik":{ai:"underwriting",f:"Greg Krasnov",l:"PH digital bank licence",m:"~$140M+ raised"},
"Maya":{ai:"underwriting",f:"PLDT/Voyager (Orlando Vea)",l:"PH digital bank + EMI + VASP",m:"~$300M+ raised"},
"GoTyme Bank":{l:"PH digital bank licence (Tyme x Gokongwei)"},
"UnionDigital":{l:"PH digital bank licence"},
"UNO Digital Bank":{ai:"underwriting",l:"PH digital bank licence"},
...
"GXBank":{l:"Digital bank licence (BNM); Grab-led"},
"AEON Bank":{l:"Islamic digital bank licence (BNM)"},
"Boost Bank":{l:"Digital bank licence (BNM); Axiata"},
"Ryt Bank":{ai:"interface",f:"YTL x Sea",l:"Digital bank licence (BNM)",s:"Malaysia's AI-first bank: an LLM assistant as the primary interface."},
"PayPay Bank":{l:"Bank (JP); SoftBank ecosystem"},
"Minna Bank":{f:"Fukuoka FG",l:"Bank licence (JP)",s:"Japan's first digital-native bank, built cloud-first."},
"Rakuten Bank":{ai:"underwriting",l:"Bank; Public (JP)"},
"LINE Bank TW":{l:"Virtual bank licence (TW FSC)"},
"NEXT Bank":{l:"Virtual bank licence (TW FSC)"},
...
"Airtel Payments Bank":{l:"Payments bank licence (RBI)"},
"Jio Payments Bank":{l:"Payments bank licence (RBI)"},
/* ANZ */
"Up":{f:"Ferocia (Dom Pym, Grant Thomas)",l:"On Bendigo & Adelaide Bank licence",s:"Built by a tiny Melbourne studio; consistently Australia's most-loved banking app."},
"Judo Bank":{l:"ADI licence",m:"Public (JDO)"},
...
/* Hybrid majors */
"Revolut":{ai:"interface",f:"Nik Storonsky, Vlad Yatsenko",l:"UK banking licence (2024); EU licence (Lithuania)",m:"~$2B raised; val ~$75B",s:"From a fee-free FX card in Canary Wharf to a 50M-user global super-app; the UK licence took nine years.",a:["EU","NA","OC","ASIA","LATAM"]},
...
"Venmo":{l:"PayPal's US state licences (money transmitter, NMLS 910457); crypto via NYDFS trust company PayPal Digital",f:"Andrew Kortina, Iqram Magdon-Ismail",m:"PayPal (PYPL)"},
...
"Coinbase Card":{ai:"agentic",f:"Brian Armstrong, Fred Ehrsam",l:"US state licences, MiCA; Public (COIN)",m:"Public (COIN)"},
...
"BitPay Card":{l:"BitLicense (NYDFS) + FinCEN MSB + 20+ state money-transmitter licences",f:"Tony Gallippi, Stephen Pair"},
"Strike":{l:"Money transmitter licences + NY BitLicense (NYDFS, 2026); Zap Solutions, Inc.",f:"Jack Mallers",m:"~$90M raised",s:"Chicago Lightning evangelist turning bitcoin rails into invisible remittance infrastructure."},
"Xapo Bank":{f:"Wences Casares",l:"Gibraltar banking licence",s:"Casares — patient zero of Silicon Valley bitcoin — built a private bank for BTC wealth after his family lost everything to Argentine devaluations."},
...
"Uphold":{l:"FinCEN MSB + state money-transmitter licences (US); FCA-registered cryptoasset firm (UK)",f:"Halsey Minor (CNET founder)"},
...
"Krak":{f:"Kraken",l:"US state licences; MiCA (EU)",s:"Kraken's move from exchange to money app: spend, yield and P2P Kraktags on one balance."},
...
"RedotPay":{l:"Hong Kong MSO, money lender + TCSP licences; VASP (RedotX UAB, Lithuania FCIS); MSB registrations (US/Canada)",ai:"agentic",f:"Michael Gao",m:"~$90M raised",s:"Hong Kong crypto-card factory reportedly carrying ~60% of global crypto-card volume by 2026."},
"Bitpanda":{f:"Eric Demuth, Paul Klanschek, Christian Trummer",l:"MiCA (AT); BaFin licences",m:"~$500M; unicorn"},
...
"Deel":{l:"MSB + US state money-transmitter licences (DPayments); US wallet via Alviere/CFSB; DLUSD via Bridge",f:"Alex Bouaziz, Shuo Wang",m:"~$680M raised",s:"Payroll for 1.5M global workers; issued its own DLUSD stablecoin on Stripe's Bridge + Privy + Tempo stack.",a:["NA","EU","LATAM","ASIA","AF","MENA","OC"]},
...
/* Web3-native */
"MetaMask":{ai:"agentic",f:"Aaron Davis, Dan Finlay (Consensys)",l:"Self-custodial software — no banking licence needed; card via licensed issuer partners",m:"Consensys ~$725M raised",s:"Born inside Consensys in 2016, the wallet that onboarded a generation to Ethereum — now shipping mUSD, the Card, and Agent Wallet for autonomous finance."},
"Phantom":{f:"Brandon Millman, Chris Kalani, Francesco Agosti",l:"Self-custodial software",m:"~$270M (val $3B)"},
"Solflare":{l:"Self-custodial software; card via issuer partners"},
...
"Zengo":{f:"Ouriel Ohayon + 3",m:"~$24M raised",l:"MPC self-custody; no seed phrase"},
...
"Ready":{f:"Itamar Lesuisse, Gerald Goldstein",m:"~$50M raised (as Argent)",s:"Argent pioneered smart-account wallets and social recovery; rebranded to Ready to become an onchain bank."},
...
"Kontigo":{l:"Self-custodial MPC wallet (USDC); no licence of its own; fiat rails via partners",f:"Jesus Castillo, Gino Guatavita",m:"$20M seed (Dec 2025; DST Global, Y Combinator, Coinbase Ventures)",s:"Ex-Venmo/Nubank/Rappi team hit $30M annualized revenue, $1B payment volume and 1M users in under 12 months — with six engineers and one designer."},
...
"Sling Money":{f:"Mike Hudack, Simon Amor",m:"~$30M raised",s:"Ex-Monzo/Facebook team making stablecoin P2P feel like iMessage, on Solana."},
...
"Fiat24":{l:"Swiss fintech licence (FINMA)",s:"Your bank account is literally an NFT on Arbitrum; Swiss-regulated, onchain-settled."},
...
const INV={
  ...
  "Sling Money": [["Union Square Ventures","usv.com"],["Ribbit Capital","ribbitcap.com"],["Slow Ventures","slow.co"]],
...
function openDetail(name){
  ...
  const fields=[["Category",CATLONG[c]],["Audience",NICHE[ni]],["HQ",hq],["Founded",f],["Custody",CUST[cu]],
    ["Licence / regulation",lic],["Founders",e.f||"—"],["Funding",e.m||"—"],
...
function regTypeOf(r){
  ...
  if(/pursuing|preparing/.test(t))return"Licence pending (partner model today)";
  if(/partner bank|partner:|partner banks|(^|\s)on .*licence|rails|jv on|operates on|subsidiary/.test(t))return"Partner-bank model";
  ...
  if(/charter|banking licence|bank licence|bank \(|private bank|mutual bank|\badi\b|internet-only|virtual bank|digital bank|digital full bank|digital wholesale|payments bank|small finance|microfinance|\bmfs\b|sofipo|ifpe|bank licences|bank;/.test(t))return"Licensed bank";
  if(/e-money|\bemi\b/.test(t))return"E-money institution";
  if(/payment institution|psan|\bmpi\b|payment licences|payment\/fintech|mobile money|e-money issuer|afsl/.test(t))return"Payment institution";
  if(/vasp|msb|bitlicense|vara|trust|casp|state licences|registrations/.test(t))return"VASP / MSB / crypto licences";
  if(/broker/.test(t))return"Broker-led";
  if(/fintech licence/.test(t))return"Fintech licence (CH)";
  return"Other / mixed";
}
let regF="";
let countryF="";
...
function openDetail(name){
  ...
  const fields=[["Category",CATLONG[c]],["Audience",NICHE[ni]],["HQ",hq],["Founded",f],["Custody",CUST[cu]],
    ["Regulation type",regTypeOf(r)],["Licence / regulation",lic],["Founders",e.f||"—"],["Funding",e.m||"—"],
    ["Card",nw==="—"?"No card":nw+" · "+ct],["Cashback",cb],["Yield",y],
    ["Stablecoins",st?"Yes":"No"],["KYC",KYC[kyc]]];
  const badge=(e.f||e.s||e.m)?'<span class="enrich">researched profile</span>':'<span class="enrich pending">base profile — enrichment pending</span>';
...
["TymeBank",10,"customers","2024"],["MiniPay",10,"wallets","2025"]];
const VOL=[
...
function openDetail(name){
  ...
  const facts=[["Category",CATLONG[c]],["Audience",NICHE[ni]],["HQ",hq],["Card",nw==="—"?"No card":nw+" · "+ct],
    ...
    ["Licence detail",lic],["Founders",e.f||"—"]];
  document.getElementById('dwrap').innerHTML=
...
const NEWS=[
/*NEWS-AUTO-START*/
["Jul 24","OCC Denies Wise's US National Trust Bank Charter","via The Defiant · Trust Bank, Wise","https://news.google.com/rss/articles/CBMinwFBVV95cUxOeWZvbkFQdmxSQjJMY2VnM0YwWnpnN2tBMHRHcUtmb1J1WDkxUXh5TFFlaHNPSlVrU29tcG90aFNYX0VlZWtVSkNBQXNPQ2ljMmtuc3F2cUlrbUs0UDl1WHlKT0NuZVRXem1sVW9oYXNFZXVpUFhBMG5SRFJiZ2pnejVWa0k1X3RoeDhsWlFrSlFJdjN0aTRILTB4WjFxbkE?oc=5"],
["Jul 23","MariBank Philippines secures digital banking licence from BSP","via IBS Intelligence · MariBank","https://news.google.com/rss/articles/CBMiogFBVV95cUxOc0R5d21xSURKZFA3dWtZVHFMZU1aTjM5MEMxWWRtQUdyWVRYT1VGOTVaUUJrOXV5ZnZJMVBkb2hjVjdKbk11eUJaWFpTUTNPdW1yYy1oYUV2Wk5UVHhWcVlsZldiRlhsX0xwc2tKSFJ4S0pmckJ4cHhQOGhYa0ZsX2tLNHprWTdDVTU1VVMxMzlKVWhDN215VzNubDNLUGV3Ymc?oc=5"],
["Jul 21","OpenAI Names BNY, Nubank CEOs to Board Ahead of IPO","via Bloomberg.com · Nubank","https://news.google.com/rss/articles/CBMiowFBVV95cUxPSjY4S0loNU5uSWdsOC1aX1dzanloVzJuc2hZbG5zaEFDdVYxMXdwd1h6bHNPa2dIM3Zfd002ajdnd3laV29wS0Y5TVhEdFlZZWp5WkhIRVlpY0xBRGR2amY0ZzJfdlBHWlhvdmtJcGJNa2gtRWZ6aDc2ZXZtNEdlZUx1eDRiUVdCdlNSdzJzNVJGeVBzQlAzMXpBMEZMWkJOdWlN?oc=5"],
["Jul 20","Chime Unveils Investing Product, Diversifying Beyond Banking","via Bloomberg.com · Chime","https://news.google.?oc=5"],
["Jul 16","MetaMask Parent Consensys Taps Wall Street for 2026 IPO","via CoinMarketCap · MetaMask","https://news.google.com/rss/articles/CBMingFBVV95cUxPcmNLNXllaTQ1a0dxbkZ2VlFGOHM0YjhfVzNVeE0zN1JURXNXRmtXTEVaeGt3amhYZWVSVlFwN3hqY2VzRXI5SVZJc0N0OXVvY1hJaDVKMDdjVzVIdlUtdHBEOFQ4cU41YjJ4Umhtd004MkJmYVBsemM3bnAzWGZFRUc0RVNwZUc3QVFFd2lTWXVKUm5uMzVLYktuRTBOQQ?oc=5"],
["Jun 25","GCash parent Mynt files for a $1.5 billion IPO that would reset what Southeast Asian fintech is worth","via Startup Fortune · GCash","https://news.google.?oc=5"],
["Jun 23","MiniPay launches Visa debit card to connect stablecoin users in emerging markets to global spending","via PR Newswire · MiniPay","https://news.google.?oc=5"],
...
["Jun 10","Egypt’s largest bank takes stake in fintech unicorn MNT-Halan, lifting valuation to $1.4 billion","via Business Insider Africa · MNT-Halan","https://news.google.?oc=5"],
["Jun 2","Digital Bank Forbright Seeking to Raise $158 Million in US IPO","via Bloomberg.com","https://news.google.?oc=5"],
...
["May 27","Falcon Finance and Anchorage Digital Bank Launch fUSD, a GENIUS-Ready Stablecoin with Rewards on Ceffu","via ETF.com · Ready","https://news.google.?oc=5"],
["May 20","Mercury hits $5.2 billion valuation as fintech firm banks on AI startups","via Reuters · Mercury","https://news.google.?oc=5"],
["May 18","Stablecoin neobank Fasset raises $51m Series B","via FinTech Futures · Fasset","https://news.google.com/rss/articles/CBMif0FVX3lxTFBOZE1HWjZoVUFmSkFEdW1KR2NVOUtDY1lvRmtaXzNNZ1ZlVjlMd1lXWnY1eVRDQXNqZVBUSjVUekNXQURnUnJKMWg5eGozaC1YdUZvVUNESVRDOV9jR2pqQnc2MFl2RDNyMUxBaENsUTM0X3hUU2N5YzlUTi1UVk0?oc=5"],
["May 14","Klarna Beats Estimates With $1 Million Profit in First Quarter","via Bloomberg.com · Klarna","https://news.google.?oc=5"],
["May 8","Exodus Launches XO Cash Stablecoin for AI Agent Payments","via Yahoo Finance · Exodus","https://news.google.com/rss/articles/CBMioAFBVV95cUxPNERfN0RRaTNSU3BYUm4wY1pDVWI1bXI5Uy1RdVdBa0ZGTGptcFRxLUVjX1dlNklGOVNRNXgxMUxtaVl3T3pROFl6V1ljY1BkX0l4UTEwTXkzQVlOZlR1dVJzRlpqdElaWENNeEpjTUZsRTJkalBlS29rNGNqMEY4MGZaQ3hyY3NvelBpaW9LOFN1bDk2TGVkLXhXVkt5cmZ2?oc=5"],
["May 4","Chinese fintech OPay eyes US IPO with $4B valuation","via Semafor · OPay","https://news.google.com/rss/articles/CBMimAFBVV95cUxPWmdJV1dGclhicFV3bHZhbFNkcUJFX0FTS1RtSFJ6RlhOMS1sTHF4SDgyVWoweDRDdG9OVmh4cjlpemxFalNpalUxZFRmNkJkMDZNX2xFVnBtNjN3eXdPaWkyT0MyQUlNWkxhYzhxWWFFcWZqcDNyOHhfOUR2Z2dBX0NyVnpUU2MyQlY2RVotcUhaU0pIUkM5ZQ?oc=5"],
["Apr 21","Revolut eyes valuation of up to $200B in eventual IPO","via TechCrunch · Revolut","https://news.google.com/rss/articles/CBMikAFBVV95cUxPUE5Fako1Qkw0VTBXdjFFNzhQSDkydXdHdWc1MDl4VVRuOWdGZF9DM1J3Y0RTWU9SWGNzX2lRNlNSam9Mc28xc0d5cmFMT2VFcWFrX3JFR2p5VkRqc0YtZXB1a1JUN1NZNmdIUGlhNVdKeDBtaWY0T3pDS05OZTZzb2E4Qi1CMVZIYzVzYU5fbEw?oc=5"],
...
["Apr 15","eToro shares jump on news of Zengo acquisition in crypto and prediction market move","via dlnews.com · Zengo","https://news.google.com/rss/articles/CBMipAFBVV95cUxOcjFOSlF1bnFSdGs0S2ZwQnBzRXlmMjJtaDkxbFFJdHhpbzlSUGJtX1R5ZDMtZDQwekdtRkdQMzVoVkhheHBzLU5aT1JSUWVEQVU4WFBoZVdaMF8zSnA2MW5tU21tVkNPN2NreDdiMW95Tm1QcVZKZ1IwMlU2bWdrb04tWjF6WFhHUnowUk5vcEk5NTRlZmNhMUhXdlBZT3NpZXBsdg?oc=5"],
["Apr 6","Mexico’s Plata Names Ex-Banker Kantt CFO as Digital Bank Eyes IPO","via Bloomberg.com · Plata","https://news.google.?oc=5"],
["Mar 19","From Kiosks to Cloud: The Tech Stack That Made GoTyme Bank Africa’s First Profitable Neobank","via Launch Base Africa · GoTyme Bank","https://news.google.?oc=5"],
...
["Mar 12","Kredivo Group Acquires Vietnamese Digital Bank Timo in Regional Push","via Fintech Singapore · Timo","https://news.google.com/rss/articles/CBMijwFBVV95cUxPS2NqWFRrTVMxSUFSQXJjWUVHWHdpd3ZSOVZWWUZqN19kYlVJb0dpRXdBemEyWHg5SFdfeTUwY1V0YVZzX2FPZDE0VVEzMG5PYjF1QVpjSU13X1l2SjJadGJYc1ljWHU2ajhfdkVNYjFfVURJc0s4eGxnUGgzNUdrNkFlZ0xxNmpXYmFqdEJzUQ?oc=5"],
["Mar 10","Oman-Led Funding Values Uzbek Fintech Uzum at $2.3 Billion","via Bloomberg.com · Uzum","https://news.google.?oc=5"],
["Mar 5","Neobank Ualá raises $195m at $3.2bn valuation","via Retail Banker International · Ualá","https://news.google.com/rss/articles/CBMihwFBVV95cUxOSGoyRkoyRGhvOGR4a3pFajZnVGk5UXYwNENVMTFJdnlzelRNSnp0QmoySEQ0YTdLdmIydERRZFZla3RUdFVjS3p2VXJ6ZGljMXVBMnBVcl81M0RVbllJS1lSSGo0TEtRWXoyU1VpSW9BR2haUzNsU1dnS1ltd2R3bElKWjlTRG8?oc=5"],
...
["Feb 25","Allica Bank becomes Europe’s newest unicorn with $155m Series D","via Sifted · Allica Bank","https://news.google.com/rss/articles/CBMiYEFVX3lxTFBxMGVIeXFqTFAxYWZXam5pb05OZTFTU2k4NUM0NFNSdWZCbmttNkltTVhMWWc2WjY2TUwzc2cxa3FPZVR0cDdLTFJqYUktMzNqVS1DM1ZuRG9SUjdpUkRMNQ?oc=5"],
...
["Jan 8","Dutch neobank Bunq reapplies for a US bank charter","via American Banker","https://news.google.com/rss/articles/CBMikAFBVV95cUxOc1ZiSWc2RzdBRnZrNDhYNUc3ZzZzT09Ha1VMa210aHdtcmtoanM1YkJzdHVQbk5FdDF0TGhfWkdYbWIyZWtFMWR2aEYyVEd4SWNoWXlQY2dLVVFETFR5RFZLNzUwdldmOUx0cHcyRGYyU21WLXI0dGFkY0xnNnJZYmlOUl9oQWR1a1dVa1Z5cXQ?oc=5"],
["Jan 7","European Neobank bunq Files for Banking License in US","via PYMNTS.com · bunq","https://news.google.com/rss/articles/CBMimwFBVV95cUxPNEhldkF1Ym9sQVlQN1BYQVlvSHZFNEljU2k2RXVqVkViczNYOEFUb2p3SGNBY1ZQa19QZGpMWHhEV0tSdGpPaWlIamkzaF9EVEZFSlhoRFpxTmFFeHBMSnZzSWRlRHBFb3dCcHRpRnF4VVBLTTBJbmJ5T0dOU2FMQ21zTVFGMUJ5clVMME9wQUpmMUtIaGpLOElVYw?oc=5"]
/*NEWS-AUTO-END*/
];
const NEWS_UPDATED="2026-07-26";
(function buildNews(){
...
function openDetail(name){
  ...
  const facts=[["Category",esc(CATLONG[c])],["Audience",esc(NICHE[ni])],["HQ",esc(hq)],["Card",esc(nw==="—"?"No card":nw+" · "+ct)],
    ...
    ["Licence detail",esc(lic)],["Founders",esc(e.f||"—")]];
...
"Purple":{t:"https://www.getpurple.io/terms-of-service",p:"https://www.getpurple.io/privacy-policy",x:"joinpurple",cc:["United States"]},
...
"Sumeria (Lydia)":{t:"https://www.sumeria.eu/en/legal/",x:"sumeria_app",cc:["France"]},
...
/* LatAm */
"Nubank":{t:"https://nubank.com.br/en/contract/",x:"nubank",in:{"David Vélez":"https://www.linkedin.com/in/david-velez-38185311/","Cristina Junqueira":"https://www.linkedin.com/in/cristina-junqueira-9a4b012/"},cc:["Brazil","Mexico","Colombia"]},
"Ualá":{t:"https://www.uala.com.ar/legales",x:"uala",in:{"Pierpaolo Barbieri":"https://www.linkedin.com/in/pierpaolo-barbieri-b8a3644/"},fx:{"Pierpaolo Barbieri":"pierpaolo"},cc:["Argentina","Mexico","Colombia"]},
...
/* Asia */
"KakaoBank":{t:"https://www.kakaobank.com/terms",x:"kakaobank",cc:["South Korea"]},
"Toss Bank":{t:"https://www.tossbank.com/terms",p:"https://www.tossbank.com/privacy",x:"toss_bank",cc:["South Korea"]},
"Maya":{t:"https://www.maya.ph/terms-and-conditions",p:"https://www.maya.ph/privacy",x:"mayaiseverything",cc:["Philippines"]},
"Tonik":{t:"https://tonikbank.com/terms-conditions",p:"https://tonikbank.com/privacy-policy",x:"TonikBankPH",cc:["Philippines"]},
...
"SadaPay":{t:"https://sadapay.pk/terms-of-service/",p:"https://sadapay.pk/privacy-policy/",x:"sadapay",cc:["Pakistan"]},
...
"FamPay":{t:"https://fampay.in/terms",p:"https://fampay.in/privacy",x:"FamPayHQ",cc:["India"]},
/* ANZ */
...
"MiniPay":{t:"https://www.minipay.to/terms",p:"https://minipay.to/privacy-statement",x:"MiniPay",cc:["Nigeria","Kenya","Ghana","South Africa","Uganda","Brazil","Philippines"]},
/* MENA */
"Telda":{t:"https://www.telda.app/terms",p:"https://www.telda.app/privacy",x:"telda",cc:["Egypt"]},
...
"Wirex":{t:"https://wirexapp.com/terms-and-conditions",p:"https://wirexapp.com/privacy-policy",x:"wirexapp",cc:["United Kingdom","European Union","Singapore","Australia","United States"]},
...
"Krak":{t:"https://krak.com/legal",p:"https://www.kraken.com/legal/privacy",x:"krak",cc:["United States","European Union","United Kingdom","Canada","Australia"]},
"KAST":{t:"https://www.kast.xyz/terms",p:"https://www.kast.xyz/legal/privacy-policy",x:"Kast_money",cc:["Hong Kong","Singapore","Global"]},
...
"Bitpanda":{t:"https://www.bitpanda.com/en/legal",p:"https://www.bitpanda.com/en/privacy-policy",x:"bitpanda",cc:["Austria","Germany","France","Spain","Italy","United Kingdom"]},
...
"Ready":{t:"https://www.ready.co/terms",p:"https://www.ready.co/legal/privacy/ready",x:"ready_co",in:{"Itamar Lesuisse":"https://www.linkedin.com/in/itamarl/"},fx:{"Itamar Lesuisse":"itamarl"},cc:["United Kingdom","European Union","Global"]},
"Plasma One":{t:"https://www.plasma.to/terms",p:"https://www.plasma.to/privacy",x:"Plasma",fx:{"Paul Faecks":"paulfaecks"},cc:["Global"]},
"Oobit":{t:"https://oobit.com/terms-of-service",p:"https://www.oobit.com/legal/privacy-notice",x:"oobit",cc:["Singapore","European Union","Global"]},
"Sling Money":{t:"https://sling.money/terms",p:"https://sling.money/privacy",x:"slingmoney",in:{"Mike Hudack":"https://www.linkedin.com/in/mhudack/"},fx:{"Mike Hudack":"mhudack"},cc:["United States","United Kingdom","European Union","Nigeria","Kenya","Global"]},
"Deblock":{t:"https://deblock.com/legal/terms",p:"https://deblock.com/legal/privacy",x:"DeblockApp",cc:["France","European Union"]},
"Fiat24":{p:"https://fiat24.com/privacy",x:"Fiat24Official",cc:["Switzerland","Global"]},
...
"Fasset":{t:"https://www.fasset.com/terms",p:"https://www.fasset.com/privacy",x:"fassetofficial",cc:["UAE","Indonesia","Malaysia","Türkiye"]},
...
"Plata":{t:"https://platacard.mx/es/docs/",x:"bancoplatamx",cc:["Mexico"]},
"Veera":{t:"https://veera.com/terms",p:"https://veera.com/privacy",x:"On_Veera",cc:["Global"]},
"Moneco":{t:"https://moneco.app/terms",x:"moneco_app",cc:["France","Belgium","Germany"]}
};
...
(function(){
  ...
  navigator.modelContext.provideContext({tools:[
    ...
    {name:'get_neobank',
     description:'Get the full record for one neobank by exact name: licence, card network, cashback, yield, KYC, founders, funding, investors, reported users with sources.',
