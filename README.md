...
[![neobanks tracked](https://img.shields.io/badge/neobanks-374-89B0FF)](https://www.neobankbeat.com)
...
an independent, open-source directory of **374 verified-active neobanks** across three waves:<br>
...
<a href="https://www.neobankbeat.com"><img src="docs/screenshot.png" alt="neobankbeat directory — 374 neobanks with filters, custody spectrum and world map" width="800"></a>
...
```mermaid
pie showData title 374 neobanks by category
...
- **[directory](https://www.neobankbeat.com)** — 374 verified-active entities; filter by category, custody, region, country, audience niche, regulation, stablecoin support; side-by-side compare tray. filters live in the URL, so views are shareable: [`?cat=W&map=AF`](https://www.neobankbeat.com/?cat=W&map=AF) = web3-native in Africa
...
| resource | what it is |
|---|---|
| [`data.json`](https://www.neobankbeat.com/data.json) | the full dataset as clean JSON — all 374 entities, every field, with sources. no HTML parsing needed |
...
├── const D=[...]   374 entities, one row each
...
n/                  374 generated entity profile pages (SEO surface)
